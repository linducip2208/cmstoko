                    ...
                    @foreach ($order->items as $item)
                        <li class="flex gap-4 p-5">
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                @if ($item->product && $item->product->isDownloadable() && $order->isPaid())
                                    <a href="{{ route('account.download', $item->id) }}"
                                       class="mt-2 inline-flex items-center gap-1.5 rounded-md bg-accent-soft px-3 py-1.5 text-xs font-semibold text-accent-ink hover:bg-accent-soft/70">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="h-3.5 w-3.5" aria-hidden="true"><path d="M10.75 2.75a.75.75 0 0 0-1.5 0v8.614L6.295 8.235a.75.75 0 1 0-1.09 1.03l4.25 4.5a.75.75 0 0 0 1.09 0l4.25-4.5a.75.75 0 0 0-1.09-1.03l-2.955 3.129V2.75Z"/><path d="M3.5 12.75a.75.75 0 0 0-1.5 0v2.5A2.75 2.75 0 0 0 4.75 18h10.5A2.75 2.75 0 0 0 18 15.25v-2.5a.75.75 0 0 0-1.5 0v2.5c0 .69-.56 1.25-1.25 1.25H4.75c-.69 0-1.25-.56-1.25-1.25v-2.5Z"/></svg>
                                        Unduh
                                    </a>
                                @endif
